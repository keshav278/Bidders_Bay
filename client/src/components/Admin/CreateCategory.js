      ...
      <div className='createItemPage'>
        ...
        <div className='formContainer' >
          ...
          <Grid container direction={"column"} spacing={2.5}>
            ...
            <Grid item>
            <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px',textAlign:'center'}} variant='h5' >Create a Category</Typography>
              <br />
              <div> 
                  <TextField 
                  name = "name"
                  ...
                  fullWidth
                  inputProps={{ style: { color: "black", fontFamily: "Roboto Slab" } }} 
            ...
            <Grid item>
              <Typography style={{color:'black',fontFamily:'Roboto Slab'}}>Select the place of this category on the hierarchy:</Typography>
              <br />
              {<div style={{backgroundColor:'#00203fff',padding:'5px',borderRadius:'10px',textAlign:'center'}}> 
