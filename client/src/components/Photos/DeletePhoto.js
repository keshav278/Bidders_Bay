    ...
    <div>
      ...
      >
        <Box sx={style}>
          ...
          <Typography sx={{fontFamily: 'Roboto Slab'}} variant="h2" component="h2">Remove Photo</Typography>
          <br />
          <DisplayPhotos images={props.images} setSelectedImage={setSelectedImage} />
          <br />
          <Typography sx={{fontFamily: 'Roboto Slab'}} variant="h7" component="h2">Would you like to delete this photo?</Typography>
          <br />
