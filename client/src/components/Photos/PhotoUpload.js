...
function PhotoUpload(props) {
    ...
    if (selectedFile) {
        ...
        return (
            <div>
                <Typography sx={{fontFamily: 'Roboto Slab'}} variant="h6" >File: {selectedFile.name}</Typography>
                <Typography sx={{fontFamily: 'Roboto Slab'}} variant="h6" >Type: {selectedFile.type}</Typography>
