  ...
  return (
    <> 
      ...
      {  Object.keys(selectedCategory).length > 0  ?
        <Typography sx={{fontFamily:'Roboto Slab'}} variant='h3'>{selectedCategory.name}</Typography>
        :
        <Typography sx={{fontFamily:'Roboto Slab'}} variant='h3'>Shop by Category</Typography>
      }
