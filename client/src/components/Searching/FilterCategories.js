    ...
    const displayItems = finalList.slice( visitedPages, visitedPages + itemsPerPage ).map((value, key)=>{
      return <div className='item' onClick={()=>{navigate(`/item/${value.id}`)}}> 
              ...
              <div className='footer'>
                  <div style={{fontFamily:'Roboto Slab'}} > {value.location}, {value.country}</div> 
                  <div style={{ color: 'white',fontFamily:'Roboto Slab' }}> {value.currently} € &nbsp;&nbsp;</div>
              </div>
              </div>
    });
...
<Typography sx={{fontFamily:'Roboto Slab'}} variant='h3'>Search Auctions</Typography>
    ...
    <br /> 
        ...
        <div className="searchInputs">
          ...
          {/* The search bar */}
          <input style={{backgroundColor:'#00203FFF'}} type="text" placeholder="Type to search..." value={wordBar} onChange={filterSearch} onKeyDown={finalSearch}/>
        ...
        { finalList.length===0 && complete &&
          ...
          <div className='container' style={{
            ...
            <Typography sx={{fontFamily: 'Roboto Slab'}} variant="h4">
                            no auctions found
                    </Typography>
                    </div>
            <img alt="nothing" src='https://indususedcars.com/assets/theme/images/no_result_found.png' />
            <Typography style={{fontFamily:'Roboto Slab'}}>Clear your search criteria and broaden your search</Typography>
            </>
        }
