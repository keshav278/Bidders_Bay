    ...
    return (
        <>
            ...
            <div className='itemPage'>
                ...
                <div className='leftSide' id="individual">
                    ...
                    <br />
                        <div className='footer'>
                            <Typography variant='h4' style={{backgroundColor:'#02003FFF',color:'white',fontFamily:'Roboto Slab',textDecoration:'underline',borderRadius:'10px',padding:'5px'}}>Description</Typography>
                        </div>
                        <br />
                        {editMode ? 
                            <div className='shake' onClick={() => {
                                ...
                                <div className='body'>
                                <Typography variant='h5' style={{backgroundColor:'#02003FFF',color:'white',fontFamily:'Roboto Slab',borderRadius:'10px',padding:"5px"}}>Edit description</Typography>                        
                                </div>
                            </div>
                        :
                            <div className='body'>
                                <Typography variant='h5' style={{backgroundColor:'#02003FFF',color:'white',fontFamily:'Roboto Slab',borderRadius:'10px',padding:'5px'}}>{itemObject.description}</Typography>
                            </div>
                        }
                        <br />
                        {editMode ? 
                    ...
                    <div className='rightSide' id="individual" >
                        { editMode ? <div className='shake' onClick={() => {
                            editItem("name");}} > <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h3'>{itemObject.name}</Typography></div> : 
                            <div className="itemNB "> 
                            <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h3'>{itemObject.name}</Typography>
                        </div> }
                        ...
                        { editMode ?
                            <div className='shake' onClick={() => {
                                ...
                                return (
                                    <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h4'>Category: {value}&nbsp;&nbsp;</Typography>
                                );
                                }
                                )}
                            </div>
                        ...
                        { (Object.keys(categories).length > 0) &&
                            <>
                            {
                                categories.map((value, key)=>{
                                return (
                                    <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h5'>Category: {value}&nbsp;&nbsp;</Typography>
                                );
                                }
                                )}
                            </>
                        ...
                        <br />
                            ...
                            <div style={{
                                ...
                                <PointOfSaleSharpIcon style={{color:'white'}} />
                                { sellerObject.saleCount ? 
                                (   <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h5'>&nbsp;Seller Rating: {sellerObject.sellerRating} &nbsp; Average: &nbsp;
                                    <Rating name="read-only" value= {sellerObject.sellerRating/sellerObject.saleCount } readOnly precision={0.5}/>
                                    </Typography>
                                )
                                :
                                (   <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h5'>&nbsp;No Sales Yet
                                    </Typography>
                                )
                                } 
                                </div> 
                            ...
                            <div className='container' > 
                            {
                                ...
                                <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h6' >{`Sold by: ${sellerObject.username}`}</Typography>
                                </Link>
                                <h7>Click to visit their profile</h7>
                                </>
                            ...
                            {( ! (authState.id === itemObject.UserId) &&itemObject.buy_price &&  authState.status===true && ! (authState.username === "admin") ) && itemObject.state==="AVAILABLE" &&
                                ...
                                <br></br>
                                <br></br>
                                <div style={{border:'5px solid black',borderRadius:'10px',display:'flex',flexDirection:'column',alignItems:'center',padding:'5px'}}>
                                { editMode ? 
                                <div className='shake' onClick={() => {
                                    editItem("started");}} > 
                                    <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h6'
                                     >{`Start Date: ${new Date(itemObject.started).toLocaleDateString('en-GB', options)}`}
                                     </Typography>
                                    </div> : 
                                    <div className='footer'  style={{ color: 'black'}}>
                                    <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h6'
                                ...
                                <div className='shake' onClick={() => {
                                    editItem("ends");}} > 
                                        <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h6'
                                     >{`End Date: ${new Date(itemObject.ends).toLocaleDateString('en-GB', options)}`}
                                     </Typography>
                                    </div> : 
                                    <div className='footer'  style={{ color: 'black'}}>
                                         <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h6'
                            ...
                            {itemObject.state==="PURCHASED" &&
                                <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h6' >Purchased!!</Typography>
                            }
                            {itemObject.state==="EXPIRED" &&
                                <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h6' > Auction Expired!</Typography>
                            }

                            {/* if there is at least one bid placed display the highest bidder so far */}
                            {
                                allBids.length>0 &&
                                <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px'}} variant='h6'  >{`Highest Bid placed by: ${allBids[allBids.length-1].bidderName}`}</Typography>
                            }
                ...
                >
                    <Box sx={style2}>
                    <Typography  variant="h5" component="h2" style={{fontFamily:'Roboto Slab'}}>
