...
export default function Export() {
  ...
  return (
    ...
    <div>
      ...
      <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px',textAlign:'center'}} variant='h4' >Export Auction Data</Typography>
      </div>
      ...
      <div className='container' style={{ height: '100%', width: '100%' }}>
        <div style={{ height: 600, width: 1200, backgroundColor: 'white',borderRadius:'10px' }}>
          <DataGrid
            style={{borderRadius:'10px',fontFamily:'Roboto Slab'}}
            rows={itemList}
            columns={columns}
            pageSize={8}
