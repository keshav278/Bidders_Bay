        ...
        <div style={{minHeight: '100vh', width: '100%',
            ...
            <div className='createItemPage'>
                ...
                >
                    ...
                    <Typography style={{backgroundColor:'#00203FFF',fontFamily:'Roboto Slab',color:'white',borderRadius:'10px',padding:'10px', alignSelf:'center'}} variant='h5' >Create an Auction</Typography>
                        <label>Title: </label>
